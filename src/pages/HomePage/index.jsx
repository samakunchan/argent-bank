  ...
  return (
    <>
      <nav className='main-nav'>
        <Link to={'/'} className={'main-nav-logo-image'}>
          <img
      ...
      <main>
        ...
        <section className='features'>
          ...
          <div className='feature-item'>
            <img
              src='/argent-bank/assets/images/icon-chat.png'
              alt='Chat Icon'
          ...
          <div className='feature-item'>
            <img
              src='/argent-bank/assets/images/icon-money.png'
              alt='Chat Icon'
              className='feature-icon'
            />
          ...
          <div className='feature-item'>
            <img
              src='/argent-bank/assets/images/icon-security.png'
              alt='Chat Icon'
              className='feature-icon'
            />
